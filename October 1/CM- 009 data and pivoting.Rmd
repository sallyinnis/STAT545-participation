...
Complete function - all possible combinations 
use nest functions to elimate some NAs and only show with name and trt? If you want to see the differences then remove the nesting (...)
